...
def _test_bpx_only_time_derivative_for_settings(polynomial_degree: int, n_coarsest : int, n_refinements : int):
    ...
    At = hm.Operator_dt_H_Lagrange_Lagrange(nmodes, n_finest, polynomial_degree, polynomial_degree)
    ...
    print(f"GMRES with BPX preconditioner converged in {iter_bpx} iterations for polynomial degree {polynomial_degree}, n_coarsest {n_coarsest}, n_refinements {n_refinements}")
...
def _test_bpx_hybrid_for_settings(mu : float, polynomial_degree: int, n_coarsest : int, n_refinements : int):
    ...
    nmodes = int(1e5)
    n_finest = n_coarsest * (2**n_refinements)
    AtH = hm.Operator_dt_H_Lagrange_Lagrange(nmodes, n_finest, polynomial_degree, polynomial_degree)
    MtH = hm.Operator_I_H_Lagrange_Lagrange(nmodes, n_finest, polynomial_degree, polynomial_degree)
    KH = AtH+mu*MtH
